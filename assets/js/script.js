$(document).ready(() => {
  ...
  function getKeycodes() {
    return [
      ...
      { name: '&nbsp;', code: 'KC_NO', width: 1250 },
      { name: '&nbsp;', code: 'KC_NO', width: 1250 },
      { name: '無変換', code: 'KC_MHEN', width: 1250 },
      { name: '&nbsp;', code: 'KC_SPC', width: 4000 },
      { name: '変換', code: 'KC_HENK', width: 1250 },
      { name: 'かな', code: 'KC_KANA', width: 1250 },
      { name: '&nbsp;', code: 'KC_NO', width: 1250 },
      { name: '&nbsp;', code: 'KC_NO' },
      { name: '&nbsp;', code: 'KC_NO', width: 1250 },
      { width: 250 },
